...
const FlashSale = () => {
    return (
        ...
        >
            ...
            <div className="absolute top-4 right-4 sm:top-6 sm:right-6 md:top-8 md:right-8  max-w-xs sm:max-w-sm md:max-w-md bg-white p-4 sm:p-5 md:p-6">
                <div className='border-2 border-yellow-800 border-opacity-35 p-4 sm:p-5 md:p-6'>
                    ...
                    {/* Product Title */}
                    <h1 className="text-base sm:text-lg md:text-xl lg:text-2xl font-light mb-3 sm:mb-4 text-center">
                        Goldenia Engagement Ring
                    </h1>

                    {/* Product Description */}
                    <p className="text-gray-500 text-xs sm:text-sm leading-relaxed mb-4 sm:mb-6 text-center">
                    ...
                    {/* Add to Cart Button */}
                    <div className='flex items-center justify-center bg-yellow-800 bg-opacity-35 w-32 sm:w-36 md:w-40 mx-auto hover:bg-opacity-50 transition duration-300 cursor-pointer'>
