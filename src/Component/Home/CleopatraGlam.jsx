...
/>
        <div className="space-y-2 md:space-y-6 max-w-[230px] md:max-w-xs lg:max-w-md absolute right-2 md:right-5 top-1/2 transform -translate-y-1/2  md:p-0 text-right md:text-right lg:text-left">
          ...
          <p className="text-gray-900 text-xs md:text-sm lg:text-base">
            Introducing our new mesmerizing jewellery collection.Embarace your
            inner allure with the timeless elegance and radiant beauty of
            ancient Egypt, now available exclusive on AXELS jewelry
          </p>
          <button className="border-black border-2 px-2 py-1 md:px-3 md:py-2 bg-transparent text-sm md:text-base w-[40%] text-nowrap">
            SHOP NOW
          </button>
        </div>
      </div>
      ...
      <div className="flex flex-col md:flex-row items-center gap-3 mt-4 md:mt-6">
        <div className="flex items-center justify-around w-full md:flex-1 bg-slate-200 py-2  md:py-5 lg:py-3 px-4 md:px-0">
          <div className="space-y-1 md:space-y-2">
            <h1 className="text-xl md:text-4xl lg:text-4xl text-nowrap mr-2 md:mr-0 transition-transform duration-300 group-hover:scale-105">
              Luxe Abundance
            </h1>
            <p className="text-gray-500 text-xs md:text-base lg:text-sm transition-opacity duration-300 group-hover:opacity-80">
              Get 20% off with our code: LUX20
            </p>
