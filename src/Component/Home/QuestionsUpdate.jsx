        ...
        <div className='max-w-[90%] mx-auto flex flex-col lg:flex-row items-stretch gap-10 mt-16'>
            ...
            >
                ...
                <div className='flex-1 space-y-6'>
                    {/* First Article - Updated to match second article design */}
                    <div 
                    ...
                    >
                        <div className='flex items-center gap-3'>
                            ...
                            <div className='space-y-3 flex-1'>
                                ...
                                <p className='text-sm md:text-base uppercase font-semibold hidden lg:block'>How to choose the perfect <br /> Engagement ring for <br /> Beloved one</p>
                                <p className='text-sm md:text-base uppercase font-semibold block lg:hidden'>How to choose the perfect Engagement ring for  Beloved one</p>
                    ...
                    >
                        <div className='flex items-center gap-3'>
                            ...
                            <div className='space-y-3 flex-1'>
                                ...
                                <p className='text-sm md:text-base uppercase font-semibold hidden lg:block'>Caring for your jewelry: <br /> Maintenance & Cleaning <br />Complete Guide</p>
                                <p className='text-sm md:text-base uppercase font-semibold block lg:hidden'>Caring for your jewelry: Maintenance & Cleaning Complete Guide</p>
                                <div className='space-y-1'>
