...
const Register = () => {
    ...
    const handleChange = (e) => {
        ...
        if (name === 'firstName') {
            ...
            if (formData.confirmPassword) {
                setErrors(prev => ({
                    ...prev,
                    confirmPassword: validateConfirmPassword(formData.confirmPassword, formattedValue)
                }));
            }
    ...
    useEffect(() => {
        const firstNameValid = !errors.firstName && formData.firstName.trim().length >= 2;
        const lastNameValid = !errors.lastName && formData.lastName.trim().length >= 2;
                ...
                <div className="bg-white py-8 px-6 shadow rounded-lg sm:px-10 md:px-12">
                    <form className="space-y-2 md:space-y-3" onSubmit={handleSubmit}>
                        ...
                        <div>
                            ...
                            {touched.password && errors.password ? (
                                ...
                                <div className="mt-2 space-y-1">
                                    <p className="text-xs md:text-sm font-medium text-gray-700">Password Requirements:</p>
                        ...
                        <div className="flex items-start">
                            ...
                            />
                            <label htmlFor="agree-terms" className="ml-2 block text-sm md:text-base text-gray-900">
                                I agree to the{' '}
