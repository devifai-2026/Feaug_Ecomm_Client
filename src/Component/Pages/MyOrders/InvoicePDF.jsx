...
const InvoicePDF = ({ order }) => {
  // Extract subtotal from amount string
      ...
      <Page size="A4" style={styles.page}>
        ...
        <View style={[styles.row, { marginBottom: 20 }]}>
          ...
          <View style={styles.section}>
            ...
            <Text style={styles.value}>{new Date(order.date).toLocaleDateString('en-IN', {
              day: 'numeric',
              month: 'long',
              year: 'numeric'
            })}</Text>
        ...
        <View style={styles.totalSection}>
          ...
          <View style={styles.totalRow}>
            ...
            <Text style={[styles.value, { color: '#10b981' }]}>FREE</Text>
          </View>
          <View style={styles.totalRow}>
            <Text style={styles.value}>GST (18%)</Text>
            <Text style={styles.value}>₹{tax.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</Text>
          </View>
          <View style={[styles.totalRow, { marginTop: 10 }]}>
            <Text style={styles.grandTotal}>Total Amount</Text>
            <Text style={styles.grandTotal}>{order.amount}</Text>
          </View>
        </View>
        ...
        <View style={styles.footer}>
          ...
          <Text>For any queries, contact: support@feauag.com | +91 98765 43210</Text>
