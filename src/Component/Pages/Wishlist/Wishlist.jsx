...
const Wishlist = () => {
  ...
  const handleRemoveItem = (id, e) => {
    ...
    toast.custom((t) => (
      <div
        className={`animate-slideInRight max-w-md w-full bg-white shadow-lg rounded-lg pointer-events-auto flex ring-1 ring-black ring-opacity-5`}
      >
    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white py-8 md:py-12">
      ...
      <div className="max-w-[95%] md:max-w-[90%] mx-auto px-2 md:px-4">
        ...
        {wishlistItems.length > 0 ? (
          ...
          <div className="text-center py-6 md:py-8 animate-scaleIn">
          ...
          <div className="mt-8 md:mt-12 text-center animate-fadeInUp">
            <div className="bg-gradient-to-r from-gray-50 to-white p-6 md:p-8 border border-gray-200">
              ...
              <p className="text-gray-600 text-sm md:text-base mb-4 md:mb-6 max-w-lg mx-auto px-2 md:px-0">
                Move items to your cart to complete your purchase. Your saved
                items will be waiting for you here.
              </p>
              <button
