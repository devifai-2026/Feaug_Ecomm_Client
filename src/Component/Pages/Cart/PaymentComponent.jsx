...
import { BsCreditCard, BsCash, BsShieldCheck, BsLock } from "react-icons/bs";
        ...
        <div className="lg:col-span-1 space-y-4">
          {paymentMethods.map((option) => {
            ...
            return (
              <label
                key={option.value}
                className={`flex items-center p-4 border rounded-xl cursor-pointer transition-all duration-200 group relative overflow-hidden ${
                  isSelected
        ...
        <div className="lg:col-span-2">
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 h-full p-6 relative overflow-hidden">
            ...
            <div className="absolute top-0 right-0 p-4 opacity-5">
              {paymentMethods
                .find((m) => m.value === paymentData.method)
                ...
                <div className="space-y-4 mt-2">
                  <div className="p-5 rounded-xl border border-dashed border-gray-300 bg-gray-50">
                    ...
                    <div className="mt-4 text-xs text-gray-500 flex items-center gap-1 justify-center sm:justify-start">
                      ...
                      Securely support all payment methods via Razorpay.
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <ul className="text-sm text-yellow-800/80 space-y-1 list-disc pl-4">
                        <li>
                          Pay exact amount of{" "}
                          <b>₹{(total + 50).toLocaleString("en-IN")}</b> upon
                          delivery.
                        </li>
                        <li>
